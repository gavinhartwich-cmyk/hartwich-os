...
export default function Column({
  ...
  return (
    <div className="flex w-72 shrink-0 flex-col">
      ...
      <div
        ref={setNodeRef}
        className={`flex min-h-[120px] flex-1 flex-col gap-2 rounded-xl border border-dashed p-2 transition-colors duration-200 ${
          isOver ? "border-white/30 bg-white/[0.04]" : "border-white/10"
        }`}
      >
        {deals.map((deal) => (
